...
public class Glava2_2_1 extends AppCompatActivity {
    TextView text;
    TextView name;
    ImageView pers1;
    ImageView pers2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glava2_2_1);
        ...
        dialogList.add("Нуу, может на позапрошлых выходных… ");
        dialogList.add("Ну вот, тогда ты тем более должна пойти! Отдохнёшь от этой школьной рутины!");
        showQuestion();
