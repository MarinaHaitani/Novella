...
public class Glava1_6_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glava1_6_2);
        ...
        dialogList.add("Знаешь, я не пойду на урок.");
        dialogList.add("Ну, как знаешь...Только на эти выходные ничего не планируй, я вытащу тебя из дома на настоящее веселье");
        ...
        dialogList.add("Ладно, давай поговорим об этом позже");
        showQuestion();
