...
public class Glava2_2_2 extends AppCompatActivity {
    TextView text;
    TextView name;
    ImageView pers1;
    ImageView pers2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glava2_2_2);
        ...
        dialogList.add("В том году … на дне благотворительности…");
        dialogList.add("*Задумавшись отвечаю я, хотя понимаю, что этот диалог я проиграла. Я действительно давно не была на тусовке. *");
        dialogList.add("Ты издеваешься? На этом тухлом сборище ботаников? Ты обязана пойти и отдохнуть от этой школьной рутины!");
        showQuestion();
    ...
    public void showQuestion() {
        ...
        if (Dialog < dialogList.size()) {
            ...
            Intent gl1_4 = new Intent(this, Glava2_3.class);
